...
func breakingRecords(scores: [Int]) -> [Int] {
    ...
    var numberOfLowestScores = 0
    var numberOfHighestScores = 0
    guard var lowestScore = scores.first,
        var highestScore = scores.first else { return  [0,0]}
        
        for score in scores {
            if score < highestScore {
                numberOfLowestScores += 1
                highestScore = score
            }
    ...
    return [numberOfHighestScores, numberOfLowestScores]
}
