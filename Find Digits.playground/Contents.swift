...
//    let numberAsStringArray = Array(String(n))
//
//    for numberAsString in numberAsStringArray {
//        guard let numberToCompare = Int(String(numberAsString)) else { return numberOfDivisors}
//        if (numberToCompare != 0) && (n % numberToCompare == 0) {
//            numberOfDivisors += 1
//        }
//    }
//
...
func findDigits(n: Int) -> Int {
    ...
    for number in numberAsString {
        guard let numberToCompare = Int(String(number)) else { return numberOfDivisors}
        if (numberToCompare != 0) && (n % numberToCompare == 0) {
            numberOfDivisors += 1
        }
    }
